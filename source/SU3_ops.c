...
double complex * SU3_identity;
//	Identity for SU(3).

double complex * SU3_null;
//	Null element for SU(3).
...
void SU3_multiplication_by_scalar(double complex * u, double complex alpha, double complex * alpha_times_u){
...
//  and returns result in uvw.
    ...
    // double complex *uv = (double complex *) malloc(3 * 3 * sizeof(double complex));
    
	// SU3_product(u,v,uv);    //  First calculates product of u and v,
    // SU3_product(uv,w,uvw);  //  then calculates product of uv and w.

	
	SU3_copy(SU3_null, uvw);
	for (int a = 0; a < 3; a++) {   //  lines
        for (int b = 0; b < 3; b++) {   //  columns
...
void SU3_projection(double complex * x, double complex * x_SU3){	

//	Projects matrix u to the group SU(3) returning SU(3) matrix x_SU3.
...
//  More explanation below.
	...
	double complex v_prime[3];                   //  matrix.


	double complex aux_prod1;    //  Auxiliaries to calculate last line
	double complex aux_prod2;    //  of projected matrix.
